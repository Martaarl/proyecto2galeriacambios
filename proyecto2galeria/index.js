...
firstLabel.className.add("marca");
firstLabel.textContent = 'Marca';

const firstSelect = document.createElement('select');
firstSelect.className.add("marca");

const options = ['Nike Original', 'New Balance', 'Adidas Original'];
...
formulary.append(firstDiv, secondDiv, divFiltrado, divBorrado, divFlecha);
firstSection.appendChild(formulary);
